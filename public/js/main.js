...
for (let i = 0; i < commentButtons.length; i++) {
    ...
    commentButton.addEventListener('click', function() {
        ...
        switch(pressed) {
            case true:
                pressed = false;
                elementToModify.innerHTML = '<div class="reply-bar"></div> <div class="reply-draft"> <div class="reply-draft-header"> <img class="profile-picture" src="assets/images/profile_picture.jpg" alt="Profile Picture"> <div class="draft-details"> <div class="username"> Placeholder </div> <div class="timestamp"> Replying to Placeholder </div> </div> </div> <div class="reply-draft-content"> <textarea class="reply-text-input" placeholder="Type your Magnum Opus..."></textarea> </div> <div class="reply-draft-footer"> <div class="post-btn"> <i class="post-icon fa-solid fa-arrow-up"></i> <div class="post-text">Post</div> </div> <div class="attachment-btn"> <input type="file" class="file-input" style="display: none;" /> <i class="attachment-icon fa-solid fa-link"></i> <div class="attachment-text">Add Attachment</div> </div> <div class="character-count">0/500</div> </div> </div>';
